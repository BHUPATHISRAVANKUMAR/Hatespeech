			...
			%>
              <table border="1" align="left" cellpadding="0" cellspacing="0" >
                  <tr >
                    ...
                    <td height="47" ><div align="center" class="style70 style73">Post Title  </div></td>
                ...
                <tr >
                  <td width="131" height="74" ><div align="center" class="style70">Post Description  </div></td>
                ...
                <tr>
                  <td  width="153" valign="middle" height="31" style="color: #2c83b0;"><div align="left " class="style15 style11 style71 style77" style="margin-left:20px;">
                    <div align="center">Comment By</div>
                  </div></td>
                  <td  width="131" columnspan="2" valign="middle" height="31" style="color: #2c83b0;"><div align="left " class="style15 style11 style71 style77" style="margin-left:20px;">
                    <div align="center">Date</div>
                  </div></td>
                  <td  width="305" height="31" align="center" valign="middle" style="color: #2c83b0;" columnspan="2"><div align="left " class="style15 style11 style71 style77" style="margin-left:20px;">
              ...
              <%a=1;}%>
                ...
                <tr>
                  <td height="43"><div align="center" class="style78 style76 style10 style9"><strong><%= c_user%></strong></div></td>
               ...
               <%}}%>
                <tr>
                  ...
                  <td colspan="2"><form id="form1" name="form1" method="post" action="U_CyberMessage.jsp">
...
%>
          ...
          <div class="clr"></div>
          <div align="right"><a href="U_CyberFriendsPosts.jsp" class="style63">Back</a></div>
        </div>
        <div class="article">
