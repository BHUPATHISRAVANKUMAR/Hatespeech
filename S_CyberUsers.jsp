...
<head>
<title>Cyber Users Comments on Posts..</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style1"><span class="style34"><span class="style12">Cyber Hate of speech Users.. </span></span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
            ...
            <div>
              <table width="646" border="1" align="center"  cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td  width="182" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style56 style57 style62">User Image </div></td>
                  <td  width="161" valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style56 style57 style62">User Name</div></td>
                ...
                <%
						...
						try 
						{
						   	...
						   	String query="select distinct(user) from cybercomments"; 
                ...
                <tr>
                  ...
                  <td><label> </label>
                      <form method="post" action="S_CyberUsersDetails.jsp">
                        <label>
                        <div align="center">
                          <p>
...
%>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li>
              <p><a href="S_CyberUsers.jsp">Home</a></p>
