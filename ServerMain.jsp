...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style1"><span class="style12">Welcome to Server Main </span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
...
.</p>
        ...
        <div class="article">
          <h2> Detecting Hate Speech Categorization With Social Media Filters </h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
        ...
        <div class="gadget">
          ...
          <ul >
            <li><a href="ServerMain.jsp">Home</a></li>
             <li><a href="S_AllUsersandAuthorize.jsp">All Users / Authorize </a></li>
             <li><a href="S_AddFilters.jsp">Add Filters </a></li>
            <li><a href="S_AllPosts.jsp">View Posts (Non-Hate of speech Trace) </a> </li>
            <li><a href="S_FRR.jsp">Friend Request / Response</a></li>
            <li><a href="S_CyberUsers.jsp">Adaptive Diffusion  Trace)</a> </li>
            <li><a href="ChartResults.jsp">Adaptive Diffusion Chart Results</a> </li>
