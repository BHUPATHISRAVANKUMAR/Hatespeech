          ...
          <div class="img">
            ...
            <form action="U_AddPost1.jsp" method="post" enctype="multipart/form-data">
              <table width="648" border="0" align="center">
                <tr>
                  <td width="186"><span class="style39">Post Title <span class="style42">(Required)</span></span></td>
                ...
                <tr>
                  <td><span class="style39">Choose Image <span class="style42">(Required)</span></span></td>
                  <td><input type="file" id="file" name="file" /></td>
				  
                </tr>
                <tr>
                  <td><span class="style39">Uses <span class="style42">(Required)</span></span></td>
                  <td><p>
                      <label>
                ...
                <tr>
                  <td><span class="style39">Post Description <span class="style42">(Required)</span></span></td>
                  <td><p>
                      <label>
                ...
                <tr>
                  <td height="77"><span class="style39">Message <span class="style42">(Required)</span></span></td>
                  <td valign="top">
                      <label>
