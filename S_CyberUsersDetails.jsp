...
<head>
<title>Cyber Hate of speech Comments by Users..</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style1"><span class="style34"><span class="style12">Cyber Hate of speech Comments by <span class="style17 style17"><%=request.getParameter("username")%></span> ..</span></span></h2>
          <p class="style1">&nbsp;</p>
          <div>
			...
			<%
					...
					String str1="select distinct(post) from cybercomments where user='"+username+"' "; 
			...
			%>
              <table border="1" align="left" cellpadding="0" cellspacing="0" >
                  <tr >
                    ...
                    <td width="196" ><div align="center" class="style70 style73">Post Title </div></td>
                    <td width="196" height="47" ><div align="center" class="style69"><strong><%= p_Name%></strong></div></td>
                  </tr>
                  <tr >
                    <td ><div align="center" class="style70"> Created By </div></td>
                    <td height="47" ><div align="center" class="style69"><strong><%= creator%></strong></div></td>
                  </tr>
                  <tr >
                    <td ><div align="center" class="style70">Date</div></td>
                    <td height="47" ><div align="center" class="style69"><strong><%= date%></strong></div></td>
                  </tr>
                
								 <% 
								 	String str3="select distinct(type) from cyberwords where post='"+p_Name+"' and user='"+username+"'";  
									Statement st3=connection.createStatement();
									ResultSet rs3=st3.executeQuery(str3);
									int a=0;
									while ( rs3.next() )
									{		
										String type = rs3.getString(1);
									
													String str4="select word from cyberwords where post='"+p_Name+"' and user='"+username+"' and (type='"+type+"')";  
                 ...
                 <tr>
                   ...
                   <td    colspan="2" columnspan="2" valign="middle" height="24" style="color: #2c83b0;"><div align="left " class="style15 style11 style71 style77" style="margin-left:20px;">
                       <div align="center"> Hate of speech Trace,(Detecting Hate Speech Categorization With Social Media Filters words,No.of Time commented) </div>
                   </div></td>
                 </tr><%a=1;}%>
                 <tr>
                   ...
                   <td    colspan="2" columnspan="2" valign="middle" height="48" style="color: #2c83b0;"><div align="left " class="style11 style71 style79 style80 style81" style="margin-left:20px;">
                       <div align="center"><strong><%= t%><span class="style83 style17">, Count=</span><%=t.size()%></strong></div>
                   </div></td>
                 </tr>
              <%
...
%>
          ...
          <div align="right">
            <p>&nbsp;</p>
            <p><a href="S_CyberUsers.jsp" class="style63">Back</a></p>
          </div>
        </div>
        <div class="article">
